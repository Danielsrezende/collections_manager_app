...
const String idColumn = 'collectionsId';
...
Future<void> createCollectionsTable(Database db) async {
  await db.execute('CREATE TABLE $collectionsTable ($idColumn INTEGER PRIMARY KEY AUTOINCREMENT, $titleColumn TEXT, $editionsColumn INTEGER, $statusColumn NUMERIC, $readColumn NUMERIC, $rarityColumn TEXT, $imgColumn TEXT)');
}
